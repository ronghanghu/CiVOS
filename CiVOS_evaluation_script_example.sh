...
# conda activate onevision_civos
...
python CiVOS_for_DAVIS.py --output ./evaluation_space/eval_strategy_f2/ --params ./evaluation_space/eval_example/EXAMPLE_DEBUGGING.yml
